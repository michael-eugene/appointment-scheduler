    ...
    <div>
      ...
      >
        <div class="text-center sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <p class="text-sm">Please sign in with your email and password</p>
        </div>
          ...
          <div class="px-4 pb-4 pt-8 sm:rounded-lg sm:px-10 sm:pb-6 sm:shadow">
            <form @submit.prevent="signInWithPassword" class="space-y-6">
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center">
                  <input
                    ...
                    name="remember_me"
                    type="checkbox"
                    class="h-4 w-4 rounded border-gray-300 text-emerald-500 focus:ring-emerald-500 disabled:cursor-wait disabled:opacity-50"
                  />
                  <label
                    for="remember_me"
                ...
                <div class="text-sm">
                  <a
                    class="font-medium text-emerald-400 hover:text-emerald-500"
                    href=""
                  >
              ...
              <div>
                <button
                  type="submit"
                  class="group relative flex w-full justify-center rounded-md border border-transparent bg-emerald-600 px-4 py-2 text-sm font-medium text-white hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 disabled:cursor-wait disabled:opacity-50"
                >
                  <span
            ...
            <div class="m-auto mt-6 w-fit md:mt-8">
              <span class="m-auto"
                ...
                <a class="font-semibold text-emerald-600" href="/register"
                  >Create Account</a
                >
              </span>
            </div>
